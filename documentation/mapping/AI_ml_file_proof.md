...
For complete documentation, see [Architecture_enhancements.md](../architecture/Architecture_enhancements.md) and [ONNX_integration.md](../architecture/ONNX_integration.md). For high-level architecture, deployment roles, and capabilities, see **[README.md](../../README.md)**.
